...
function initialize() {
  ...
  var mapProp = {
    center:new google.maps.LatLng(-31.3089652,-54.0880531),
    zoom:14,
   	scrollwheel: false,
     styles: [{
    stylers: [{
      saturation: -100
    }] //aqui é as propriedades do mapa em js 
     }],
...
function addMarker(lat,long,icon,content,showInfoWindow,openInfoWindow){
	  ...
	  //essa funçao serve para adicionar alguma marcação no mapa 
	  ...
	  google.maps.event.addListener(infoWindow, 'domready', function() {
	   ...
	   // Moves the shadow of the arrow 76px to the left margin 
		...
		// aqui esta sendo feita uma validaçãa que ao cliclar vai mostrar o nome do local no marcador 

		
}
initialize();

addMarker(-31.3089652,-54.0880531,'',"Minha Empresa", undefined,false);